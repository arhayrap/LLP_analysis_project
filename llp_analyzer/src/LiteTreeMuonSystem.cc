...
void LiteTreeMuonSystem::InitVariables()
{
  ...
  for( int i = 0; i < N_MAX_CSC; i++ )
  {
    ...
    cscSegCluster_match_cluster_index[i] = 999;
      ...
      dtRechitCluster_match_gParticle[i] = false;
  ...
  for( int i = 0; i < N_MAX_GPARTICLES; i++ )
  {
    ...
    gParticleDecayVertexX[i] = -999.;
    gParticleDecayVertexY[i] = -999.;
    gParticleDecayVertexZ[i] = -999.;
...
*/
  ...
  tree_->SetBranchAddress("gParticleDecayVertexX",      &gParticleDecayVertexX);
  tree_->SetBranchAddress("gParticleDecayVertexY",      &gParticleDecayVertexY);
  tree_->SetBranchAddress("gParticleDecayVertexZ",      &gParticleDecayVertexZ);
  ...
  tree_->SetBranchAddress("track_Eta",      &track_Eta);
  tree_->SetBranchAddress("track_Phi",      &track_Phi);
  tree_->SetBranchAddress("trackVertexX",      &trackVertexX);
  tree_->SetBranchAddress("trackVertexY",      &trackVertexY);
  tree_->SetBranchAddress("trackVertexZ",      &trackVertexZ);
  ...
  tree_->SetBranchAddress("dtRechitCluster_match_gParticle",             &dtRechitCluster_match_gParticle);
...
void LiteTreeMuonSystem::CreateTree()
{
  ...
  tree_->Branch("nMatched",      &nMatched,  "nMatched[nTracks]/F");
  ...
  tree_->Branch("trackVertexX",      &trackVertexX,  "trackVertexX[nTracks]/F");
  tree_->Branch("trackVertexY",      &trackVertexY,  "trackVertexY[nTracks]/F");
  tree_->Branch("trackVertexZ",      &trackVertexZ,  "trackVertexZ[nTracks]/F");

  tree_->Branch("matched_track_Pt",       &matched_track_Pt,   "matched_track_Pt[nTracks]/F");
...
*/
  ...
  tree_->Branch("gLLP_visPt",          gLLP_visPt,          "gLLP_visPt[2]/F");
