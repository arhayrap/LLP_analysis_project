...
void usage()
{
  std::cerr << "Usage: RunGMSB_STau_mass247_ctau1000  <input list>  [options]\n[options]:\n"
	    << "-d  --isData\n"
...
int main(int argc, char* argv[]){
  ...
  std::cout << "[INFO]: optionalLabel --> " << label << std::endl;
    ...
    GMSB_STau_mass247_ctau1000 analyzer(theChain);
    
    //------ EXECUTE ------//
    cout << "Executing GMSB_STau_mass247_ctau1000..." << endl;
    analyzer.EnableAll();
