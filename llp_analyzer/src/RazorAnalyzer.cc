...
void RazorAnalyzer::EnableTracks(){
    ...
    fChain->SetBranchStatus("matched_track_Pt", 1);
    // My changes
    ...
    fChain->SetBranchStatus("trackVertexX", 1);
    fChain->SetBranchStatus("trackVertexY", 1);
    fChain->SetBranchStatus("trackVertexZ", 1);
...
void RazorAnalyzer::EnableCSC()
{
    ...
    */
    ...
    fChain->SetBranchStatus("cscRechitCluster_match_gParticle", 1);
    fChain->SetBranchStatus("cscRechitCluster_match_gParticle_id", 1);
    fChain->SetBranchStatus("cscRechitCluster_match_gParticle_pt", 1);
    fChain->SetBranchStatus("cscRechitCluster_match_gParticle_eta", 1);
    fChain->SetBranchStatus("cscRechitCluster_match_gParticle_phi", 1);
    fChain->SetBranchStatus("cscRechitCluster_match_gParticle_E", 1);
    fChain->SetBranchStatus("cscRechitCluster_match_gParticle_index", 1);
    fChain->SetBranchStatus("cscRechitCluster_match_gParticle_MotherId", 1);
    fChain->SetBranchStatus("cscRechitCluster_match_gParticle_minDeltaR", 1);

    fChain->SetBranchStatus("nDtRechitClusters", 1);
    fChain->SetBranchStatus("dtRechitCluster_match_gParticle", 1);
    fChain->SetBranchStatus("dtRechitCluster_match_gParticle_id", 1);
    fChain->SetBranchStatus("dtRechitCluster_match_gParticle_pt", 1);
    fChain->SetBranchStatus("dtRechitCluster_match_gParticle_eta", 1);
    fChain->SetBranchStatus("dtRechitCluster_match_gParticle_phi", 1);
    fChain->SetBranchStatus("dtRechitCluster_match_gParticle_E", 1);
    fChain->SetBranchStatus("dtRechitCluster_match_gParticle_index", 1);
    fChain->SetBranchStatus("dtRechitCluster_match_gParticle_MotherId", 1);
    fChain->SetBranchStatus("dtRechitCluster_match_gParticle_minDeltaR", 1);
