...
void usage()
{
  std::cerr << "Usage: RunWplusHToSS_STodd_ms15_pl1000  <input list>  [options]\n[options]:\n"
	    << "-d  --isData\n"
...
int main(int argc, char* argv[]){
  ...
  std::cout << "[INFO]: optionalLabel --> " << label << std::endl;
    ...
    WplusHToSS_STodd_ms15_pl1000 analyzer(theChain);
    
    //------ EXECUTE ------//
    cout << "Executing WplusHToSS_STodd_ms15_pl1000..." << endl;
    analyzer.EnableAll();
