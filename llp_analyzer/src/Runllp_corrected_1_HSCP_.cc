...
#include <llp_corrected_1_HSCP_.h>
...
void usage()
{
  std::cerr << "Usage: Runllp_corrected_1_HSCP_  <input list>  [options]\n[options]:\n"
	    << "-d  --isData\n"
...
int main(int argc, char* argv[]){
  ...
  std::cout << "[INFO]: optionalLabel --> " << label << std::endl;
    ...
    llp_corrected_1_HSCP_ analyzer(theChain);
    
    //------ EXECUTE ------//
    cout << "Executing llp_corrected_1_HSCP_..." << endl;
    analyzer.EnableAll();
