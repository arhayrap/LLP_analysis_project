...
void usage()
{
  std::cerr << "Usage: RunWplusHToSS_SToTauTau_ms15_pl1000  <input list>  [options]\n[options]:\n"
	    << "-d  --isData\n"
...
int main(int argc, char* argv[]){
  ...
  std::cout << "[INFO]: optionalLabel --> " << label << std::endl;
    ...
    WplusHToSS_SToTauTau_ms15_pl1000 analyzer(theChain);
    
    //------ EXECUTE ------//
    cout << "Executing WplusHToSS_SToTauTau_ms15_pl1000..." << endl;
    analyzer.EnableAll();
