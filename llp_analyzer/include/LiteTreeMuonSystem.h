...
public:
  ...
  float gParticleDecayVertexX[N_MAX_GPARTICLES];
  float gParticleDecayVertexY[N_MAX_GPARTICLES];
  float gParticleDecayVertexZ[N_MAX_GPARTICLES];
  ...
  float         cscRechitCluster_match_gParticle_dR[N_MAX_CSC];
...
//  int           cscRechitCluster_match_gParticle_id[N_MAX_CSC];
  ...
  float         dtRechitCluster_match_gParticle_dR[N_MAX_CSC];
  bool          dtRechitCluster_match_gParticle[N_MAX_CSC];
  float         dtRechitCluster_match_gParticle_minDeltaR[N_MAX_CSC];
  int           dtRechitCluster_match_gParticle_index[N_MAX_CSC];
...
float         cscRechitCluster3JetVetoPt[N_MAX_CSC];
  ...
  float trackVertexX[N_MAX_TRACKS];
  float trackVertexY[N_MAX_TRACKS];
  float trackVertexZ[N_MAX_TRACKS];
  float matched_track_Pt[N_MAX_TRACKS];
  float nMatched[N_MAX_TRACKS];
