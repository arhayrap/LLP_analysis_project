...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         cscRechitCluster_match_gParticle_pt[20];   //[nCscRechitClusters]
   Float_t         cscRechitCluster_match_gParticle_eta[20];   //[nCscRechitClusters]
   Float_t         cscRechitCluster_match_gParticle_phi[20];   //[nCscRechitClusters]
   Float_t         cscRechitCluster_match_gParticle_E[20];   //[nCscRechitClusters]
   ...
   Float_t         dtRechitCluster_match_gParticle_pt[20];   //[ndtRechitClusters]
   Float_t         dtRechitCluster_match_gParticle_eta[20];   //[ndtRechitClusters]
   Float_t         dtRechitCluster_match_gParticle_phi[20];   //[ndtRechitClusters]
   Float_t         dtRechitCluster_match_gParticle_E[20];   //[ndtRechitClusters]
...
//   Int_t           dtRechitCluster_match_gParticle_id[20];   //[nDtRechitClusters]
   ...
   Float_t         trackVertexX[2002];   //[nTracks]
   Float_t         trackVertexY[2002];   //[nTracks]
   Float_t         trackVertexZ[2002];   //[nTracks]
 
   Float_t         matched_track_Pt[2002];   //[nTracks]
   Int_t           nMatched[2002];   //[nTracks]
   ...
   Float_t         track_nHits[2002];   //[nTracks]
   Float_t         track_ndof[2002];   //[nTracks]
   Float_t         track_chi2[2002];   //[nTracks]
   Int_t           nJets;
   ...
   TBranch        *b_cscRechitCluster_match_gParticle_pt;   //!
   TBranch        *b_cscRechitCluster_match_gParticle_eta;   //!
   TBranch        *b_cscRechitCluster_match_gParticle_phi;   //!
   TBranch        *b_cscRechitCluster_match_gParticle_E;   //!
   ...
   TBranch        *b_nTracks;   //!
   TBranch        *b_trackVertexX;   //!
   TBranch        *b_trackVertexY;   //!
...
void llp_event::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("cscRechitCluster_match_gParticle_pt", cscRechitCluster_match_gParticle_pt, &b_cscRechitCluster_match_gParticle_pt);
   fChain->SetBranchAddress("cscRechitCluster_match_gParticle_eta", cscRechitCluster_match_gParticle_eta, &b_cscRechitCluster_match_gParticle_eta);
   fChain->SetBranchAddress("cscRechitCluster_match_gParticle_phi", cscRechitCluster_match_gParticle_phi, &b_cscRechitCluster_match_gParticle_phi);
   fChain->SetBranchAddress("cscRechitCluster_match_gParticle_E", cscRechitCluster_match_gParticle_E, &b_cscRechitCluster_match_gParticle_E);
   ...
   fChain->SetBranchAddress("trackVertexX", trackVertexX, &b_trackVertexX);
   fChain->SetBranchAddress("trackVertexY", trackVertexY, &b_trackVertexY);
   ...
   fChain->SetBranchAddress("gLLP_dt", gLLP_csc, &b_gLLP_csc);
