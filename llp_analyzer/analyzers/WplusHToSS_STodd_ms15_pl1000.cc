#include "WplusHToSS_STodd_ms15_pl1000.h"
...
void WplusHToSS_STodd_ms15_pl1000::Analyze(bool isData, int options, string outputfilename, string analysisTag) {
  ...
  if (outfilename == "") outfilename = "/eos/user/a/arhayrap/OUTPUT_DATA/WplusHToSS_STodd_ms15_pl1000.root";
  TFile * outFile;
