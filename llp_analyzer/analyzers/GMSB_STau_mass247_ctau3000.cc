#include "GMSB_STau_mass247_ctau3000.h"
...
void GMSB_STau_mass247_ctau3000::Analyze(bool isData, int options, string outputfilename, string analysisTag) {
    ...
    if (outfilename == "") outfilename = "/eos/user/a/arhayrap/OUTPUT_DATA/GMSB_STau_mass247_ctau3000.root";
    TFile * outFile;
